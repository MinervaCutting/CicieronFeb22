...
export const tragaluz = {
  ...
  pax: 1,
  date: "8th Feb - Dinner",
  explanation: "Sala Chimenea: 50pax",
};

export const tragaluz_data = {
  variant: "h6",
  title: "",
  pdf: null,
  paras: [
    ...
    `,
    `  The restaurant has 3 private areas: Main dinning room (up to 70 pax), Altillo (30 pax) and Chimenea (50 pax):
    But they offer us 2 options: 
 <lu>
 <li> Sala Chimenea up to 50 pax</li>
 <li> From 51 to 150 pax we would need to have the restaurant in exclusive with a minimum expense of 11.000€</li>
 </lu>
 `,
 ,
  ],
